...
exports.run = async (client, message, args) => {
  ...
  const linqo = `https://flamingtext.com/net-fu/proxy_form.cgi?script=dracula-logo&text=${yazi}&_loc=generate&imageoutput=true`
  .replace(' ', '+')
  ...
  .setColor("RANDOM")
  .setImage(linqo)
  .setFooter('dracula logo Oluşturuldu')
